...
@section('wizardcontent')
	...
	@stop
	  ...
	  <font color="red"><center>Based on the information you have provided DIY Student Loan Services and the Repayment Plan you have selected:</center></font> <br/>
	  
	  <h4 style="color: black;text-align:center;background-color:yellow">YOUR NEW MONTHLY FEDERAL STUDENT LOAN PAYMENT IS <u>${{{ $NewPayment }}}</u></h4>
	  
	  
	  <center><strong>The free offer has been completed and you now have your NEW student loan payment. If you would like to have your 15 page student loan consolidation application completely filled out along with your request for student loan forgiveness and forbearance forms, please see below and select which forms you would like completed and instantly emailed to you. ALL OF THE APPLICATIONS ARE BASED OFF THE INFORMATION YOU HAVE PROVIDED.</strong></center>
	  <br/>
	  
	  <center><img src="/packages/wizard/images/moneyback.png" class="img-responsive" alt="Money Back Guarentee"></center><br/>
	  
	  <font color="red"><center>If the DOE fails to approve your student loan consolidation application due to an error of DIY Student Loan Services, DIY Student Loan Services will refund <font color="red">100%</font> of the service charged for the preparation of your documents. <br/> OUR MONEY BACK GUARANTEE IS SUBJECT TO YOU PROVIDING ACCURATE AND TRUE INFORMATION.</center></font>
	  <br/>
			  	...
			  	<div class="">
			  		...
			  		else
			  		{
						?>
					  		...
					  		<input type="checkbox" name="consolidation_promisory_note_1" value="1" data-price="99.00" id="consolidation_promisory_note_1"><label for="consolidation_promisory_note_1" class="checkbox-label"> <b>$99.00 &nbsp; A FEDERAL CONSOLIDATION APPLICATION AND PROMISORY NOTE</b></label>
					  		<?php } else { ?>
					  		<input type="checkbox" name="consolidation_promisory_note" value="1" data-price="99.00" id="consolidation_promisory_note"><label for="consolidation_promisory_note" class="checkbox-label"> <b>$99.00 &nbsp; A FEDERAL CONSOLIDATION APPLICATION AND PROMISORY NOTE</b></label>
					  		<?php } ?>
						<?php
			  		}
					?>
	  ...
	  <div class="CartProgram">
	  	<div class="row">
		  	...
		  	<div class="">
				...
				?>
		  		<?php if (number_format($NewPayment,2) <= 0) { ?>
		  		<input type="checkbox" name="repayment_promisory_note_1" id="repayment_promisory_note_1" value="1" data-price="99.00"><label class="checkbox-label" for="repayment_promisory_note_1"> <b>$99.00 &nbsp; RE-PAYMENT REQUEST APPLICATION:</b></label>
		  		<?php } else { ?>
		  		<input type="checkbox" name="repayment_promisory_note" id="repayment_promisory_note" value="1" data-price="99.00"> <label class="checkbox-label" for="repayment_promisory_note">$99.00 &nbsp; RE-PAYMENT REQUEST APPLICATION:</label>
		  		<?php } ?>
				<?php
		  		}
				?>
