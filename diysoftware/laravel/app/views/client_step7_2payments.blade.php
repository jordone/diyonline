				...
				<div class="row" style="padding-top:10px;">
					<div class="col-sm-8">
						<div class="panel panel-success">
							<div class="panel-heading">{{ OFFICE_LINK_A_NAME }}</div>
							<div class="panel-body">
							
							
								<div class="fixed_payments_a">

								<?php
								$number_payments = intval(OFFICE_LINK_A_NUM_PAYMENTS);
								$payment_amount_default = number_format($TotalDue/$number_payments,2);
								$duedate_constant = "OFFICE_LINK_A_PAYMENT%s_DEFAULT_DATE";
