@extends('wizard')
@section('wizardtitle')
STEP 5: Repayment Plans Available Upload
@stop
...
<div class="form-inline form-group">
	 <label class="col-sm-2 control-label" for="inputFirstname">Upload file here:</label>
	 <div class="col-sm-4"><input type="file" name="file" id="inputFile" required></div>
</div>
	  ...
	  <table class="table table-no-border" class="planselect">
	  	<thead style="background-color: #398ecb;font-size:23px;color:#fff;text-transform:uppercase;">
	  		<tr>
	  			...
	  			<th align="center">Your New Monthly Payments Are</th>
...
<!--	  			<td>${{{ $Plans->EXG->Forgiven }}}</td>-->
	  ...
	  <div style="background-color:#ebf3fa;margin-left:-15px;margin-right:-15px;margin-top:-15px;padding-top:-15px;">
	  	...
	  	<font color="red" style="font-size:50px;font-weight:bold" id="repaymentpricehere">$0</font><br/>
	  	</span>
	  	
	  	<label for="checkbox5" style="cursor:pointer" id="checkthebox5"><img src="/packages/static/lockin4.png" class="img-responsive"></label><br/>
	  	<br/>
	  	</center>
			  		<font color="#125280">
				  		<center><strong>
