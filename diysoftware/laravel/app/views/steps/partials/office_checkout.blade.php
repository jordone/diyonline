...
<div class="panel panel-default paypanel">
    ...
    <div class="panel-body">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-3">
                <input type="text"  class="form-control"  name="tprice" id='Tprice' style="float:left" value="{{ $client->TProperties->TotalPayments }}">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9"><select class="form-control" id="set_nopayments" name="ltf[NoPayments]">
                    @for($NoPayments=1;$NoPayments<=3;$NoPayments++)
                    <option value="{{$NoPayments}}" {{  (intval($client->TProperties->NoPayments) == $NoPayments ? "selected='selected'" : '')  }}>{{$NoPayments}} Payment(s)</option>
                    @endfor
                </select></div>
        </div>

        <div id="split_payment" class="hide">
            @include('steps.partials.office_splitpayments')
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                {{ Form::stateSelect('Billing_state', $client->TProperties->State, ["class" => "form-control required"]) }}
            </div>
        </div>
        <div class="form-group">
