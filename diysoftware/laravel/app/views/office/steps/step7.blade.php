...
<!--	<h4 class="info-text">This information is relayed to Department of Education (DOE)!<small><br/>Access a list of all your Federal Student Loans that will be consolidated into your new re-payment plan options.</small></h4>-->
	<h3 class="text-center">{{ STEP7_DISPLAY_TEXT }}</h3>
		...
		<div class="panel panel-default paypanel">
			...
			<div class="panel-body">
			  	...
			  	<div class="row">
			  		...
			  		&dollar;</div>
			  		<div class="col-sm-3">
					<input type="text"  class="form-control"  name="tprice" id='Tprice' style="float:left" value="{{ $client->TProperties->Payment1Amount }}" >
...
<br/>
		...
		You Give Permission To {{COMPANY_NAME}} To Charge/Debit Your Account For the Amount Indicated On The Total Due Line Above.
		You Have Read And Understand The Disclosures Contained On The {{COMPANY_NAME}} Website.
		</center>
